      ...
      <Row>
        <Col>
          <Card body className="my-2">
            <CardTitle tag="h3">Welcome to e-examination room.</CardTitle>
            <CardText>
              This forum allows you to answer past questions on the various
              subjects taught in senior high school. <br />
              Your results would be displayed after the time ellapses. <br />
              Note that the time duration is the same as the West Africa
              Examination time schedule for examination questions.
            </CardText>
            <hr />
